...
def main():
    while True:
        mode = input("Select mode (Image/Camera/Video, enter 'q' to exit）：")
        if mode == "q":
            break
        elif mode == "Image":
            file_path = input("Please enter the path to the image:")
            process_image_file(file_path)
        elif mode == "Camera":
            process_camera()
        elif mode == "Video":
            video_path = input("Please enter the path to the video:")
            output_path = input("Please enter the path to save the video (including file name and extension, e.g. output.avi):")
            process_video(video_path, output_path)
        else:
            print("Invalid mode. Use 'Image', 'Camera' or 'Video'.")
